...
$cons="SHOW COLUMNS FROM pasaje FROM Air";
...
<th> Seleccion Modificar <th>
  ...
  <tbody>
    ...
    while($i=mysqli_fetch_array($q)){
      ...
      <td>
      <input type='checkbox' name='eliminar[]' value='$i[id_pasaje]'/>  
      </td>
      <td>
      <input type='checkbox' name='modificar[]' value='$i[id_pasaje]'/>
      </td>
      </tr>
      ";
    }
       ...
       if(empty($_POST["eliminar"])){
         ...
         foreach ($_POST["eliminar"] as $i) {
          include '../BD/conexion.php';
           $sem="DELETE FROM pasaje WHERE id_pasaje=$i";
