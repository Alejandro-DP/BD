...
<body id="page-top ">
  <div class=" navbar navbar-expand  bg-success topbar  static-top shadow">
    ...
    <!--              DataTables                           -->
                                                        ...
                                                        if(isset($_POST['borrar'])){
                                                          if(empty($_POST["eliminar"])){
                                                            ...
                                                            foreach ($_POST["eliminar"] as $i) {
                                                              ...
                                                              $sem="DELETE FROM horarios WHERE id_horario=$i";
      ...
      <!--modificar datos-->
        <div class='miform'>
                  <form method='POST' action='../BD/pdhorarios.php'>
                  ...
                  <select name="id">
                      <?php
                     require '../BD/conexion.php';
                     $j=mysqli_query($conexion,"select *from horarios");
                ...
                ";
                      ...
                      ?>
                        ...
                        <div class='form-group'>
                          <input type='text' class='form-control' name='nom' aria-describedby='emailHelp' placeholder='Ingresa Hora'>
                          </div>
                          <div class='form-group'>
                          <input type='text' class='form-control' name='edad' placeholder='Ingresa Fecha'>
                          </div>
                          <div class='form-group'>
                 <input type='text' class='form-control' name='tel' placeholder='Ingresa Id Origen'>
                       </div>
                        <div class='form-group'>
                    <input type='text' class='form-control' name='correo' placeholder='Ingresa id destino'>
                  </div>
