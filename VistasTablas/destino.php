...
<body id="page-top ">
  <div class=" navbar navbar-expand  bg-success topbar  static-top shadow">
    ...
    <!--              DataTables                           -->
                                                        ...
                                                        if(isset($_POST['borrar'])){
                                                          if(empty($_POST["eliminar"])){
                                                            ...
                                                            foreach ($_POST["eliminar"] as $i) {
                                                              ...
                                                              $sem="DELETE FROM destino WHERE id_destino=$i";
      ...
      <!--modificar datos-->
        <div class='miform'>
                  <form method='POST' action='../BD/pddestino.php'>
                  <h6 class="text-center">Modificar Datos</h6>

                  <label>Selecciona id Destino:</label>
                  <select name="id">
                      <?php
                     require '../BD/conexion.php';
                     $j=mysqli_query($conexion,"select *from destino");
                ...
                ";
                      ...
                      ?>
                        ...
                        <div class='form-group'>
                          <input type='text' class='form-control' name='nom' aria-describedby='emailHelp' placeholder='Ingresa Aeropuerto'>
                          </div>
                          <div class='form-group'>
                          <input type='text' class='form-control' name='edad' placeholder='Ingresa Ciudad'>
                          </div>
